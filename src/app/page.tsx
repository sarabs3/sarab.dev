...
import { FaGithub, FaLinkedin, FaEnvelope, FaLink, FaRunning, FaQuoteLeft } from "react-icons/fa";

export default function Home() {
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col sm:flex-row gap-8 row-start-2 items-center sm:items-start container lg:w-[900px]">
        <div className="flex gap-4 bg-amber-100 flex-col p-4 lg:w-[300px] rounded-xl items-center lg:items-start">
          ...
          <div className="flex gap-4">
            ...
            <Link href="/quotes">
              <FaQuoteLeft size={20} className="text-orange-500" />
            </Link>
          </div>
        </div>
